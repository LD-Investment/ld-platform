...
MIGRATION_MODULES = {"sites": "ld_platform.contrib.sites.migrations"}
...
STATIC_ROOT = str(ROOT_DIR / "django_static")
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "ld_platform.utils.context_processors.settings_context",
            ],
        },
    }
]
