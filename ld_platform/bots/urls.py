...
# Bot Control
bot_command = BotControlCommandViewSet.as_view(
    {
        "post": "command",
    }
)
...
urlpatterns = [
    ...
    # Bot Control
    path("control/bot/<int:bot_id>/command", bot_command, name="bot-control-command"),
    path("control/bot/<int:bot_id>/setting", bot_setting, name="bot-control-setting"),
]
