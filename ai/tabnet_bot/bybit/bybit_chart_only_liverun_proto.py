...
def get_df():
    bybit = ccxt.bybit()
    df = pd.DataFrame(bybit.fetch_ohlcv("BTCUSDT", timeframe='4h', limit=200))
...
if __name__ == '__main__':
    ...
    try:
        ...
        if e.status_code == 34036:  # leverage unchanged
            pass
        else:
            raise e
    ...
    # load trained model
    tn = TabNetClassifier()
    tn.load_model('../trained/TabNetClassifier_Binance.zip')
